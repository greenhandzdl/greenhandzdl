...
git reset --hard origin/main  # Replace 'main' with your branch name if needed
...
git branch -D main  # Replace 'main' with your branch name if needed
git branch -m main  # Replace 'main' with your branch name if needed

# Force push the new branch to the remote repository
echo "Force pushing the new branch to remote repository..."
git push -f origin main  # Replace 'main' with your branch name if needed
